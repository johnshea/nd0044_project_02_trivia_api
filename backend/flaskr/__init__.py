...
def create_app(test_config=None):
    ...
    '''
    Endpoint to POST a new question or
    to get questions based on a search term.

    New question - Will require the question and answer text,
    category, and difficulty score.

    Search - It should return any questions for whom the search term
    is a substring of the question.

    New Question TEST: When you submit a question on the "Add" tab,
    the form will clear and the question will appear at the end of the last
    page of the questions list in the "List" tab.

    Search TEST: Search by any phrase. The questions list will update to
